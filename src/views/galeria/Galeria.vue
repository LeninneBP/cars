                ...
                <il class="card__lista" v-for="carro in carros" v-bind:key="carro">
                    <Card class="card" >
                        ...
                        {{carro.nome}}
                            ...
                            <Tag  v-bind:severity="carro.cor_tag" v-bind:value="carro.tag" rounded></Tag>
                        </template>
    ...
    data() {
        return {
            ...
            carros: [
                ...
                {
                   nome:'370z',
                   imagem:'https://media.ed.edmunds-media.com/nissan/370z/2019/oem/2019_nissan_370z_coupe_base_fq_oem_1_1280.jpg', 
